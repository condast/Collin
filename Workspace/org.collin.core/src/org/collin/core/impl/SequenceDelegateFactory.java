...
public class SequenceDelegateFactory extends AbstractDelegateFactory<SequenceNode>{
	 ...
	 */
	@Override
	public ICollINDelegate<SequenceNode> createDelegate( Class<?> clss, ITetraNode<SequenceNode> node ){
